prompt --application/shared_components/logic/application_processes/get_day_ma_sum_h
begin
--   Manifest
--     APPLICATION PROCESS: get_day_ma_sum_h
--   Manifest End
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(99775263484805978)
,p_process_sequence=>1
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'get_day_ma_sum_h'
...
'   sum_ma_h := 0;',
'   ',
'   sum_ma_h := utility_pkg.get_day_ma_sum_h(to_date(p_datum, ''DD.MM.YYYY''), p_mitarbeiter_id);',
'',
