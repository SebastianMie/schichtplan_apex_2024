...
'DECLARE',
'    p_matrix_data matrix_table_type := matrix_table_type(); -- Leeres Array des benutzerdefinierten Table Typs initialisieren',
...
'EXCEPTION',
'    WHEN OTHERS THEN',
'        -- Fehlerbehandlung: Fehler an die JavaScript-Seite weiter geben',
