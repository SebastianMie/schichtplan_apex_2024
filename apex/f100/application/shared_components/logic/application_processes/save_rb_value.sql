prompt --application/shared_components/logic/application_processes/save_rb_value
begin
--   Manifest
--     APPLICATION PROCESS: save_rb_value
--   Manifest End
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(116258990566012903)
,p_process_sequence=>1
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'save_rb_value'
...
'',
'    v_success := utility_pkg.save_rb_value(p_datum, p_mitarbeiter_id);',
'',
