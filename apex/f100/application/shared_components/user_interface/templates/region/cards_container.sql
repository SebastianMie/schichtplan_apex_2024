...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(98885326930580486)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131629850797490066)
,p_plug_template_id=>wwv_flow_imp.id(98885326930580486)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131629727851490066)
,p_plug_template_id=>wwv_flow_imp.id(98885326930580486)
,p_name=>'Sub Regions'
