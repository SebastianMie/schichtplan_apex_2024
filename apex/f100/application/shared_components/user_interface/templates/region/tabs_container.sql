...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(98856303378580475)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(98856077705580475)
,p_plug_template_id=>wwv_flow_imp.id(98856303378580475)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(98855732733580475)
,p_plug_template_id=>wwv_flow_imp.id(98856303378580475)
,p_name=>'Tabs'
