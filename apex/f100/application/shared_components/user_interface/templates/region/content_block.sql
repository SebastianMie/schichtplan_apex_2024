...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(98880270338580484)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131628081137490066)
,p_plug_template_id=>wwv_flow_imp.id(98880270338580484)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131627945941490066)
,p_plug_template_id=>wwv_flow_imp.id(98880270338580484)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131627836029490066)
,p_plug_template_id=>wwv_flow_imp.id(98880270338580484)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131627710913490066)
,p_plug_template_id=>wwv_flow_imp.id(98880270338580484)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131627603886490066)
,p_plug_template_id=>wwv_flow_imp.id(98880270338580484)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131627576268490066)
,p_plug_template_id=>wwv_flow_imp.id(98880270338580484)
,p_name=>'Change'
