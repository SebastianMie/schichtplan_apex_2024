...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(98866527410580479)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131627450486490066)
,p_plug_template_id=>wwv_flow_imp.id(98866527410580479)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131627365921490066)
,p_plug_template_id=>wwv_flow_imp.id(98866527410580479)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131627227645490066)
,p_plug_template_id=>wwv_flow_imp.id(98866527410580479)
,p_name=>'Next'
,p_placeholder=>'NEXT'
