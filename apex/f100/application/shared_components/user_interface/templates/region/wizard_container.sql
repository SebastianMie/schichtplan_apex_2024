...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(98883590874580485)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131622981985490065)
,p_plug_template_id=>wwv_flow_imp.id(98883590874580485)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131622850427490065)
,p_plug_template_id=>wwv_flow_imp.id(98883590874580485)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131622744982490065)
,p_plug_template_id=>wwv_flow_imp.id(98883590874580485)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131622687580490065)
,p_plug_template_id=>wwv_flow_imp.id(98883590874580485)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(98883221897580485)
,p_plug_template_id=>wwv_flow_imp.id(98883590874580485)
