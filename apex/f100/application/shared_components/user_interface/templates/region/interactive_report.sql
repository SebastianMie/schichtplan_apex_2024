...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(98884152106580485)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131625764923490066)
,p_plug_template_id=>wwv_flow_imp.id(98884152106580485)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131625665046490066)
,p_plug_template_id=>wwv_flow_imp.id(98884152106580485)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131625583062490066)
,p_plug_template_id=>wwv_flow_imp.id(98884152106580485)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131625429058490065)
,p_plug_template_id=>wwv_flow_imp.id(98884152106580485)
,p_name=>'Previous'
