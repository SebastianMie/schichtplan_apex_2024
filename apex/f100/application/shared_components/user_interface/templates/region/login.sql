...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(98864211133580478)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131625396596490065)
,p_plug_template_id=>wwv_flow_imp.id(98864211133580478)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131625275498490065)
,p_plug_template_id=>wwv_flow_imp.id(98864211133580478)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131625163801490065)
,p_plug_template_id=>wwv_flow_imp.id(98864211133580478)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(131625053841490065)
,p_plug_template_id=>wwv_flow_imp.id(98864211133580478)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(98863994305580478)
,p_plug_template_id=>wwv_flow_imp.id(98864211133580478)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
