...
@@application/shared_components/logic/application_processes/save_matrix_mitarbeiter.sql
@@application/shared_components/logic/application_processes/get_monat_ma_sum_h.sql
@@application/shared_components/logic/application_processes/get_limit_h_mitarbeiter.sql
@@application/shared_components/logic/application_processes/get_rb_ma.sql
@@application/shared_components/logic/application_processes/get_comment_mitarbeiter.sql
@@application/shared_components/logic/application_processes/save_rb_ma.sql
@@application/shared_components/logic/application_processes/get_feiertag.sql
@@application/shared_components/logic/application_processes/get_comment_count.sql
@@application/shared_components/logic/application_processes/open_modal_dialog.sql
@@application/shared_components/logic/application_processes/get_url_modal_rb.sql
@@application/shared_components/logic/application_processes/save_rb_value.sql
@@application/shared_components/logic/application_processes/get_day_ma_sum_h.sql
@@application/shared_components/logic/application_processes/get_sperre_mitarbeiter.sql
@@application/shared_components/logic/application_processes/get_last_sperre_info.sql
@@application/shared_components/logic/application_items/app_user.sql
@@application/shared_components/logic/application_items/session_id.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/laender.sql
@@application/shared_components/user_interface/lovs/login_remember_username.sql
@@application/shared_components/user_interface/lovs/mitarbeiter.sql
@@application/shared_components/user_interface/lovs/mitarbeiter_rolle.sql
@@application/shared_components/user_interface/lovs/monat_jahr.sql
@@application/shared_components/user_interface/lovs/monat_jahr_all.sql
@@application/shared_components/user_interface/lovs/monate.sql
@@application/shared_components/user_interface/lovs/monat_jahr_archiv.sql
@@application/shared_components/user_interface/lovs/monat_status.sql
@@application/shared_components/user_interface/lovs/service_team.sql
@@application/shared_components/user_interface/lovs/vorgabe_codes.sql
@@application/shared_components/user_interface/lovs/vorgabe_codes_display.sql
@@application/shared_components/user_interface/lovs/y_n.sql
...
@@application/shared_components/security/authentications/mitarbeiter_authentication.sql
